...
<head>
    ...
    <title>BarberVibe | Agendamentos</title>
    ...
    <div class="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10">
        <div class="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl shadow-black/30">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm uppercase tracking-[0.3em] text-amber-500">Painel</p>
                    <h1 class="mt-2 text-2xl font-semibold text-zinc-100">Seus agendamentos</h1>
                </div>
